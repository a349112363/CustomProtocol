...
-(UINavigationController *)photoListNavigationController{
    if (!_photoListNavigationController) {
        ...
        [_photoListNavigationController.navigationBar setBarTintColor:[UIColor setColor:NavgationBarTintColor]];
    }
...
-(void)showController:(UIViewController *)controller result:(ZZPhotoResult)result
{
    ...
    self.photoPickerController.width = self.width;
    self.photoPickerController.height = self.height;
